...
<script>
  ...
  import SpringConsole1 from '../../children/soulve/SpringConsole1.vue';
  ...
  export default {
  name: 'Spring 2',
  components: { SpringConsole1, Audio },
  data: () => ({
    a: false,
    cd: false,
    gd: false,
  ...
  methods: {
    ...
    failedPilgrimage: async function (a) {
      if (typeof a !== 'string') {
        return;
      }
      this.fx = {
      ...
      // console.log('Failed Pilgrimage', this.fx);
    }
  }
}
</script>
