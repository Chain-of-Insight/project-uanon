<template>
  <div class="autumn-wrap gg" v-if="asc">
    <div class="video gg"></div>
    <div class="sealed jumbotron">
      <p alt="Solve the pre-puzzle to move forward Pilgrim" title="Solve the pre-puzzle to move forward Pilgrim">Picking flowers in foreign lands to make honey in china</p>
      <div class="dont even whisper for the birds and the mice might hear you">
        <div class="ctrlr">
          <button class="btn btn-primary tk" @click="k();">
            <span class="icon-display"></span>&nbsp;<span>There is no wish for the person who died after their stomach is full</span>
          </button>
        </div>
      </div>
    </div>
  ...
  <div class="autumn-wrap gg" v-if="!asc && !ld">
    <div class="sealed jumbotron">
      <div class="title-bar">
        <h3>Your Truth lacks evidence</h3>
        <hr class="ruler">
      </div>
      <p class="blood">Entrance requires holding <span class="italic">Anima from the Vine of Noology</span></p>
    </div>
  </div>
