<template>
  ...
  <div class="summer-wrap console" v-if="rdy">
    <div class="content-s summer puzzle-content" v-if="p.id">
      <div class="content-i">
        <iframe id="crowd" src="https://www.youtube.com/embed/sXwdj5E-aHk?rel=0&amp;autoplay=1&mute=0&enablejsapi=1&controls=0&loop=1&playlist=sXwdj5E-aHk" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </div>
